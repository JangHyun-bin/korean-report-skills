...
[![release](https://img.shields.io/badge/release-v1.14.0-0066cc)](../../releases)
...
마크다운을 워드에 붙이면 볼품없고, HTML로 제작 할 경우 **매번 일관되지 않은 디자인과 구성으로 표현합니다.**
